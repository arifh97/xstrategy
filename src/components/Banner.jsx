  ...
  render() {
    return (
      <section className='banner overflow-hidden position-relative shape'>
        <div className="banner-img position-absolute"><img src={bannerShape} alt="" /></div>
        <Container>
          <Row>
            <Col lg={{span:10, offset:1}} className="text-center">
              <div className="banner-content">
                <span className="meta_text text-uppercase text-primary d-inline-block mb-2">Web3 Gaming</span>
                <h1 className='mb-4'>Financial Services for <span>Metaverse and</span> Web3 Gaming Platforms</h1>
                <p className='mb-4 mb-lg-5 fw-semibold'>
